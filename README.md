...
См. также [гайд по сборке](##гайд-по-сборке)
...
4. Используем CMake чтобы структурировать проект (см. [возможная структура проекта](##возможная-структура-проекта))
...
## Credits
* [Григорий Петрунин](https://github.com/via8) - создал все интерфейсы и вообще хороший человек
